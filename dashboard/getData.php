...
$query_masuk = mysqli_query($koneksi, "SELECT COUNT(*) AS total_masuk FROM tb_masuk") or die(mysqli_error($koneksi));
$query_keluar = mysqli_query($koneksi, "SELECT COUNT(*) AS total_keluar FROM tb_keluar") or die(mysqli_error($koneksi));
